...
function isPalindrome(str) {
  ...
  const reverse = str
    ...
    .reverse()
    .join('');
  return reverse === str.replaceAll(regex, '').toLowerCase();
}
...
function findLongestWord(sentence) {
  const maxLength = sentence
    ...
    .map((e) => e.length)
    .sort((a, b) => b - a)[0];
  return sentence.split(' ').find((e) => e.length === maxLength);
}
...
function invertCase(str) {
  return str
    .split('')
    .map((e) => (e === e.toLowerCase() ? e.toUpperCase(0) : e.toLowerCase()))
    .join('');
}
...
function encodeToRot13(str) {
  ...
  str.split('').forEach((element) => {
    element.split('').forEach((i) => {
      if (lettersUpper.includes(i)) {
        if (lettersUpper.indexOf(i) + 13 < 26) {
          result.push(lettersUpper[lettersUpper.indexOf(i) + 13]);
        } else {
          result.push(lettersUpper[lettersUpper.indexOf(i) + 13 - 26]);
        }
      } else if (lettersLower.split('').includes(i)) {
        if (lettersLower.indexOf(i) + 13 < 26) {
          result.push(lettersLower[lettersLower.indexOf(i) + 13]);
        } else {
          result.push(lettersLower[lettersLower.indexOf(i) + 13 - 26]);
        }
      } else {
        result.push(i);
      }
